...
// Brand glyphs use fill; generic icons use stroke. All inherit currentColor.
const TwitterIcon = (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.66l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25h6.832l4.713 6.231L18.244 2.25z" />
  </svg>
);
